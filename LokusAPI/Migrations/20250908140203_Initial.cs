        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentSubscriptionId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Companies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Companies_Subscriptions_CurrentSubscriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentSubscriptionId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customers_Subscriptions_CurrentSubscriptionId",
                        column: x => x.CurrentSubscriptionId,
                        principalTable: "Subscriptions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OverallRatings = table.Column<int>(type: "int", nullable: false),
                    ParkingRatings = table.Column<int>(type: "int", nullable: false),
                    WifiRatings = table.Column<int>(type: "int", nullable: false),
                    PlugRatings = table.Column<int>(type: "int", nullable: false),
                    PriceRatings = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Stablishments", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stablishments_Images_ProfileImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Price = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    PriceEnum = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_CurrentSubscriptionId",
                table: "Companies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stablishments_ProfileImageId",
                table: "Stablishments",
                column: "ProfileImageId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Customers_Images_ProfileImageId",
                table: "Customers",
                column: "ProfileImageId",
                principalTable: "Images",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Images_Stablishments_StablishmentId",
                table: "Images",
                column: "StablishmentId",
                principalTable: "Stablishments",
                principalColumn: "Id");
